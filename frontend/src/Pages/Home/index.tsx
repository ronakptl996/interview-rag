...
const Home = () => {
  ...
  const fetchInterviews = async () => {
    try {
      ...
      const response = await fetch(
        `${import.meta.env.VITE_BACKEND_URL}/interview/list`,
        {
          headers: {
  ...
  return (
    <>
      ...
      />
      <div className="bg-slate-900 min-h-screen pt-12 relative px-3">
        <div className="container mx-auto max-w-7xl">
          <div className="flex justify-between items-center mb-12 flex-col md:flex-row">
            ...
            {interviews.length != 0 && (
              <button
                ...
                className="bg-slate-700 text-white px-8 py-4 rounded-xl hover:bg-slate-600 transition-all duration-300 flex items-center gap-3 shadow-md hover:shadow-lg transform hover:-translate-y-0.5 mt-4 cursor-pointer"
              >
                <svg
                  ...
                  <div className="mt-8">
                    {interview.isCompleted ? (
                      <button
                        ...
                        className="w-full bg-indigo-600 text-white py-4 px-6 rounded-xl hover:bg-indigo-700 transition-all duration-300 flex items-center justify-center gap-3 shadow-sm hover:shadow-md transform hover:-translate-y-0.5 cursor-pointer"
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="h-6 w-6"
          ...
          {interviews.length === 0 && (
            <div className="text-center py-20 bg-gradient-to-br from-slate-800 to-slate-900 rounded-2xl shadow-2xl border border-slate-700/50">
              ...
              <p className="text-slate-300 text-lg mb-8 break-all">
